...
pub fn builtin_sub(this: &Value, args: &[Value]) -> RuntimeResult<Value> {
    if args.len() != 1 {
...
pub fn builtin_mul(this: &Value, args: &[Value]) -> RuntimeResult<Value> {
    if args.len() != 1 {
...
pub fn builtin_div(this: &Value, args: &[Value]) -> RuntimeResult<Value> {
    if args.len() != 1 {
