...
fn object_keys(_this: &Value, args: &[Value]) -> RuntimeResult<Value> {
    ...
    match &args[0] {
        ...
        _ => Err(RuntimeError::new("object.keys() argument must be an object")),
    }
}
...
fn object_values(_this: &Value, args: &[Value]) -> RuntimeResult<Value> {
    ...
    match &args[0] {
        ...
        _ => Err(RuntimeError::new("object.values() argument must be an object")),
    }
}
...
fn object_entries(_this: &Value, args: &[Value]) -> RuntimeResult<Value> {
    ...
    match &args[0] {
        ...
        _ => Err(RuntimeError::new("object.entries() argument must be an object")),
    }
}
...
fn object_has(_this: &Value, args: &[Value]) -> RuntimeResult<Value> {
    ...
    match (&args[0], &args[1]) {
        ...
        _ => Err(RuntimeError::new("object.has() first argument must be an object")),
    }
}
...
fn object_from_entries(_this: &Value, args: &[Value]) -> RuntimeResult<Value> {
    ...
    match &args[0] {
        ...
        _ => Err(RuntimeError::new("object.from_entries() argument must be an array")),
    }
}
...
fn object_size(_this: &Value, args: &[Value]) -> RuntimeResult<Value> {
    ...
    match &args[0] {
        Value::Struct { fields, .. } => {
            Ok(Value::Number(Decimal::from(fields.len())))
        },
        _ => Err(RuntimeError::new("object.size() argument must be an object")),
    }
}
