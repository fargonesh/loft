          ...
          <div className="flex justify-between items-center h-16">
            <div className="flex items-center gap-8">
              ...
              <nav className="hidden md:flex gap-6">
                ...
                <Link to="/d/std" className="text-sm font-medium hover:text-bio-green transition-colors">Standard Library</Link>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm">
                ...
                <li><Link to="/d/std" className="hover:text-bio-green">Standard Library</Link></li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm">
                ...
                <li><a href="https://discord.gg/fCCnRFFeNr" target='_blank' className="hover:text-bio-green">Discord</a></li>
              </ul>
            </div>
          </div>
